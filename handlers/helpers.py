...
async def log_job_error(context, job_name: str, exc: Exception):
    ...
    A differenza degli update handler, i job NON passano per app.add_error_handler,
    quindi senza questa funzione un errore qui sparirebbe nei soli log del container.
    Manda il traceback al canale log e, se configurato, al dev in privato.
    """
    import traceback
